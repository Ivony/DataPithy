...
namespace Ivony.Data.Queries
{
  ...
  public sealed class ParameterizedQueryService : IParameterizedQueryService
  {
    ...
    /// <summary>
    /// 指示在拼接 SQL 表达式时是否自动插入必要的空白字符
    /// </summary>
    public bool AutoWhitespaceSeparator { get; } = true;
    ...
    {
      return new ParameterizedQueryBuilder( this );
    }
    ...
    private class ParameterizedQueryBuilder : IParameterizedQueryBuilder
    {
      ...
      public ParameterizedQueryBuilder( ParameterizedQueryService service )
      {
        AutoWhitespaceSeparator = service.AutoWhitespaceSeparator;
      }
      ...
      /// <summary>
      /// 获取或设置在拼接 SQL 部件的时候是否自动插入必要的空白字符。
      /// </summary>
